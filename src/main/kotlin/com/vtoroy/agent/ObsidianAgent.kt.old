...
class ObsidianAgent(
    ...
    private suspend fun parseQuery(query: String, chatHistory: List<ChatMessage>, sessionId: String? = null): ParsedQuery {
        ...
        val isResponseToQuestion = chatHistory.isNotEmpty() && 
            chatHistory.lastOrNull()?.role == com.vtoroy.entity.MessageRole.ASSISTANT &&
        ...
        return try {
            ...
            sessionId?.let { 
                com.vtoroy.controller.ThinkingController.sendThought(it, "🤔 Анализирую: '$query'", "obsidian_thinking")
                com.vtoroy.controller.ThinkingController.sendThought(it, "💭 Промпт: ${userPrompt.take(100)}...", "obsidian_prompt") 
            }
            ...
            if (reasoning.isNotEmpty() && sessionId != null) {
                com.vtoroy.controller.ThinkingController.sendThought(sessionId, "💭 $reasoning", "obsidian_reasoning")
            }
            ...
            sessionId?.let { 
                ...
                com.vtoroy.controller.ThinkingController.sendThought(it, readableThought, "obsidian_action")
            }
            ...
            sessionId?.let {
                com.vtoroy.controller.ThinkingController.sendThought(it, "🤖 $fullResponse", "ai_full_response")
            }
